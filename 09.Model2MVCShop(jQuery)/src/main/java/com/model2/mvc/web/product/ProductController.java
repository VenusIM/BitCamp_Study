...
public class ProductController {
	...
	private String uploadFile(MultipartFile uploadfile, String temDir) {
	...
	public String addProduct(HttpServletRequest request, @RequestParam(value="fileName", required = false) MultipartFile uploadfile, Model model) throws Exception {
