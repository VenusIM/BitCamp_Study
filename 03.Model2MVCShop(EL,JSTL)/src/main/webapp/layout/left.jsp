...
function guest() {
	popWin = window.open("/guest.jsp","popWin","left=300, top=200, width=300, height=200, marginwidth=0, marginheight=0, scrollbars=no, scrolling=no, menubar=no, resizable=no");
}
</script>
	...
	<td valign="top"> 
		<table  border="0" cellspacing="0" cellpadding="0" width="159">
			<% if(vo == null) { %>
				<tr>
					<td class="Depth03">
						<!-- <a href="javascript:guest()">비회원구매조회</a> -->
						<a href="../guest.jsp" target="rightFrame">비회원구매조회</a>
					</td>
				</tr>
				<tr>
					<td class="DepthEnd">&nbsp;</td>
