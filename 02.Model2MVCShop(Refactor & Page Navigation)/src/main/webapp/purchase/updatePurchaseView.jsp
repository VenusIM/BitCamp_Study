...
<%
	...
	System.out.println("Date 확인 :: " + purchase.getDivyDate());
%>	
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
							maxLength="20">
				<option value="1" selected=<%= "1".equals(purchase.getPaymentOption().trim()) ? "selected" : ""%>>현금구매</option>
				<option value="2" selected=<%= "2".equals(purchase.getPaymentOption().trim()) ? "selected" : ""%>>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
