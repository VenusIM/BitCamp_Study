...
<div class= "divz" style="width:98%; margin-left:10px;">
	...
	<tr>
		<td align="center">
		   <input type="hidden" id="currentPage" name="currentPage" value=""/>
			...
			<% 		System.out.println("이전 :: "+(resultPage.getCurrentPage()-1));
				} %>

			<%	for(int i=resultPage.getBeginUnitPage();i<= resultPage.getEndUnitPage() ;i++){	%>
					<a href="javascript:fncGetUserList('<%=i %>');"><%=i %></a>
			<% 		System.out.println("페이지 클릭 :: "+i);
				}  %>
			...
			<% 		System.out.println("이후 :: "+(resultPage.getEndUnitPage()+1));
				} %>
